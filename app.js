...
const Register = require("./models/registers"); // mongodb model 
...
app.set("views", template_path);//let our application know about the updated template path.
hbs.registerPartials(partials_path);//let us register our partials 
